...
import { CSSProperties, JSX, KeyboardEventHandler, MouseEventHandler, ReactNode } from 'react';
...
export declare const Messages: {
	createConnection: <CM extends ConnectionMap, E extends Record<string, string> = Record<string, string>>({ server, subscribers, options, env, }: {
		server: string[] | string;
		subscribers?: Partial<{
			[k in keyof CM]: ConnectionListener<CM, k, E>;
		}>;
		options?: Partial<{
	...
	connectListenerToSubscription: <CM extends ConnectionMap, S extends keyof CM, E extends Record<string, string>>({ connection, subject, listener, options, env, }: {
		subject: string;
...
export declare const Reacts: {
	render: (node: import("react").ReactNode | import("react").ReactNode[], parent?: HTMLElement, container?: HTMLDivElement) => RenderControl;
...
export declare const useClickOutside: typeof useClickOutside, useEventListener: typeof useEventListener, useGuiCtx: () => GuiCtx | undefined, useRenderCount: typeof default, useUpdateGuiCtx: () => UpdateGuiCtx | undefined, useAddToDesk: () => (node: import("react").ReactNode, id?: string) => string | number | bigint | boolean | Iterable<import("react").ReactNode> | Promise<string | number | bigint | boolean | import("react").ReactPortal | import("react").ReactElement<unknown, string | import("react").JSXElementConstructor<any>> | Iterable<import("react").ReactNode> | null | undefined> | import("react/jsx-runtime").JSX.Element, useRemoveFromDesk: () => () => void, useNav: () => (path: string) => void, usePreviousPath: () => any, useBringToFront: () => (id?: string | undefined) => void, useDropzone: typeof import("react-dropzone").useDropzone, useKeyboardListener: (keyActions: KeyActions, options?: Partial<{
	ratePerSecond: number;
	parent: HTMLElement;
	debug: boolean;
	autoUp: boolean;
