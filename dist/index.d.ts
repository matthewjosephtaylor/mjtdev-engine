...
export { Arrays, Brand, Fixed, FixedArray, FixedBrand, Fixes, Nullable, Objects, Producer, Tuple0, Tuple1, Tuple2, Tuple3, Tuple4, Tuple5, TypeGuard, ValueProducer, ErrorLike, } from "@mjtdev/object";
...
export declare const isErrorLike: (maybe: unknown) => maybe is import("@mjtdev/object").ErrorLike, isErrorType: (value: unknown) => value is Error, tryValue: <T_1>(value: Error | T_1, message?: string | undefined) => T_1, orError: <T>(f: () => T, options?: Partial<{
    ...
    def: R_3;
    onError: import("@mjtdev/object").ValueProducer<string>;
}> | undefined) => Promise<R_3 | undefined>, mapValue: <T_19, R_4>(value: T_19, mapper: (value: T_19) => R_4) => R_4, headOf: <O, T_4 extends O>(obj: O | Iterator<O, T_4, undefined> | O[], typeGuard?: import("@mjtdev/object").TypeGuard<T_4> | undefined) => T_4 | undefined, tailOf: <O_11>(obj: O_11[]) => O_11[] | undefined, restOf: <O_11>(obj: O_11[]) => O_11[] | undefined, times: typeof import("@mjtdev/object/dist/object/times").times, isIterator: <T_2>(maybe: unknown) => maybe is Iterator<T_2, any, undefined>, toMultiMap: <K_13 extends string | number, T_20>(maps: Record<K_13, T_20>[], options?: Partial<{
    compact: boolean;
