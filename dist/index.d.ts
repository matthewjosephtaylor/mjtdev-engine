...
export declare const chain: <T_14>(initial: T_14, mappers: ((v: T_14) => T_14)[]) => T_14, entries: <O_6 extends object, K_7 extends keyof O_6, V_2 = O_6[K_7]>(obj: O_6) => [K_7, V_2][], filter: <O_10 extends object, K_10 extends keyof O_10, V_4 extends O_10[K_10]>(obj: O_10, predicate: (key: K_10, value: V_4) => boolean) => [K_10, V_4][], first: <O, T_2 extends O>(obj: O | Iterator<O, T_2, undefined> | O[], typeGuard?: import("@mjtdev/object").TypeGuard<T_2>) => T_2, last: <T_3>(obj: T_3[]) => T_3, forEach: <O_9 extends object, K_9 extends keyof O_9>(obj: O_9, consumer: (key: K_9, value: O_9[K_9]) => void, errorHandler?: (error: unknown, key: K_9, value: O_9[K_9]) => void) => void, iff: <T_5, R>(value: T_5, mapper: (v: NonNullable<T_5>) => R) => R, orElse: <T_11>(o: T_11, e: T_11) => T_11, removeUndefinedValues: <T_12 extends object>(obj: object) => Partial<T_12>, iffTyped: <T_6, R_1, G>(typeGuard: (maybe: unknown) => maybe is G, value: T_6, mapper: (v: T_6 & G) => R_1) => R_1, isDefined: <T_7>(obj: T_7) => obj is NonNullable<T_7>, isUndefined: <T_8>(obj: T_8) => obj is null, omit: <K extends string | number, T_9 extends { [k in K]: unknown; }>(object: T_9, key: K) => Omit<T_9, K>, omitUnsafe: <K_1 extends string | number, T_10 extends { [k_1 in K_1]: unknown; }>(object: T_10, key: K_1) => Omit<T_10, K_1>, toMany: <T_13>(obj: T_13 | Iterable<T_13> | T_13[]) => T_13[], fromEntries: <K_11 extends string | number | symbol, V_5>(entries: readonly (readonly [K_11, V_5])[]) => Record<K_11, V_5>, safe: <R_2>(producer: () => R_2, options?: Partial<{
    ...
    def: R_3;
    onError: import("@mjtdev/object").ValueProducer<string>;
}>) => Promise<R_3>, mapValue: <T_17, R_4>(value: T_17, mapper: (value: T_17) => R_4) => R_4, headOf: <O, T_2 extends O>(obj: O | Iterator<O, T_2, undefined> | O[], typeGuard?: import("@mjtdev/object").TypeGuard<T_2>) => T_2, tailOf: <O_11>(obj: O_11[]) => O_11[], restOf: <O_11>(obj: O_11[]) => O_11[], times: typeof import("@mjtdev/object/dist/object/times").times, isIterator: <T>(maybe: unknown) => maybe is Iterator<T, any, undefined>, toMultiMap: <K_13 extends string | number, T_18>(maps: Record<K_13, T_18>[], options?: Partial<{
    compact: boolean;
}>) => Record<K_13, T_18[]>, timesGen: typeof import("@mjtdev/object/dist/object/timesGen").timesGen, isIterable: typeof import("@mjtdev/object/dist/object/type/isIterable").isIterable, isArrayLike: <T_1>(maybe: unknown) => maybe is ArrayLike<T_1>, iffBrowser: <T_19>(producer: () => T_19) => T_19, isBrowser: () => boolean, toPromise: <T_20>(producer: (callback: () => void) => T_20) => Promise<T_20>, all: {
