...
export declare const Objects: {
    ...
    times: typeof times;
    first: <O, T_2 extends O>(obj: O | Iterator<O, T_2, undefined> | O[], typeGuard?: import("..").TypeGuard<T_2>) => T_2 | undefined;
    last: <T_3>(obj: T_3[]) => T_3 | undefined;
    fix: <T_4>(v: T_4) => Readonly<import("..").FixedBrand<T_4>> | undefined;
    iff: <T_5, R>(value: T_5, mapper: (v: NonNullable<T_5>) => R) => R | undefined;
    iffTyped: <T_6, R_1, G>(typeGuard: (maybe: unknown) => maybe is G, value: T_6, mapper: (v: T_6 & G) => R_1) => R_1 | undefined;
    includesUndefined: (...arr: unknown[]) => true | undefined;
    isDefined: <T_7>(obj: T_7 | null | undefined) => obj is NonNullable<T_7>;
    isUndefined: <T_8>(obj: T_8 | null | undefined) => obj is undefined;
    ...
    freeze: <T_15>(v: T_15) => Readonly<T_15 | undefined>;
    ...
    headOf: <O, T_2 extends O>(obj: O | Iterator<O, T_2, undefined> | O[], typeGuard?: import("..").TypeGuard<T_2>) => T_2 | undefined;
    ...
    isBrowser: () => boolean;
    iffBrowser: <T_19>(producer: () => T_19) => T_19 | undefined;
