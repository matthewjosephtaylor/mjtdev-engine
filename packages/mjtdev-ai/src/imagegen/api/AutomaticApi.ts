...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  sdapi = {
     ...
     */
    getStateSdapiInterpauseConfigGet: (params: RequestParams = {}) =>
     ...
     */
    fTxt2ImgSdapiInterpauseTxt2ImgPost: (data: Txt2ImgRequest, params: RequestParams = {}) =>
      this.request<ImageResponse, HTTPValidationError>({
     ...
     */
    fImg2ImgSdapiInterpauseImg2ImgPost: (data: Img2ImgRequest, params: RequestParams = {}) =>
      this.request<ImageResponse, HTTPValidationError>({
     ...
     */
    fUpscaleSdapiInterpauseUpscalePost: (data: UpscaleRequest, params: RequestParams = {}) =>
      this.request<UpscaleResponse, HTTPValidationError>({
  ...
  openOutpaint = {
     ...
     */
    returnModelUnetChannelCountOpenOutpaintUnetCountPost: (
      data: BodyReturnModelUnetChannelCountOpenOutpaintUnetCountPost,
      params: RequestParams = {},
    ) =>
      this.request<any, HTTPValidationError>({
  ...
  controlnet = {
     ...
     */
    moduleListControlnetModuleListGet: (
      query?: {
        /**
         * Alias Names
         * @default false
     ...
     */
    settingsControlnetSettingsGet: (params: RequestParams = {}) =>
      this.request<any, any>({
  ...
  infiniteImageBrowsing = {
     ...
     */
    greetingInfiniteImageBrowsingHelloGet: (params: RequestParams = {}) =>
      this.request<any, any>({
     ...
     */
    globalSettingInfiniteImageBrowsingGlobalSettingGet: (params: RequestParams = {}) =>
      this.request<any, any>({
     ...
     */
    deleteFilesInfiniteImageBrowsingDeleteFilesPost: (data: DeleteFilesReq, params: RequestParams = {}) =>
      this.request<any, HTTPValidationError>({
     ...
     */
    moveFilesInfiniteImageBrowsingMoveFilesPost: (data: MoveFilesReq, params: RequestParams = {}) =>
      this.request<any, HTTPValidationError>({
     ...
     */
    getTargetFloderFilesInfiniteImageBrowsingFilesGet: (
      query: {
        /** Folder Path */
        folder_path: string;
      },
     ...
     */
    thumbnailInfiniteImageBrowsingImageThumbnailGet: (
      query: {
        /** Path */
        path: string;
        /** T */
     ...
     */
    getFileInfiniteImageBrowsingFileGet: (
      query: {
        /** Path */
        path: string;
        /** T */
     ...
     */
    apiSetSendImgPathInfiniteImageBrowsingSendImgPathPost: (
      query: {
        /** Path */
        path: string;
      },
     ...
     */
    apiSetSendImgPathInfiniteImageBrowsingGenInfoCompletedGet: (params: RequestParams = {}) =>
      this.request<any, any>({
     ...
     */
    imageGeninfoInfiniteImageBrowsingImageGeninfoGet: (
      query: {
        /** Path */
        path: string;
      },
     ...
     */
    checkPathExistsInfiniteImageBrowsingCheckPathExistsPost: (data: CheckPathExistsReq, params: RequestParams = {}) =>
      this.request<any, HTTPValidationError>({
     ...
     */
    indexBdInfiniteImageBrowsingGet: (params: RequestParams = {}) =>
      this.request<any, any>({
     ...
     */
    openFolderUsingExploreInfiniteImageBrowsingOpenFolderPost: (data: OpenFolderReq, params: RequestParams = {}) =>
      this.request<any, HTTPValidationError>({
     ...
     */
    getDbBasicInfoInfiniteImageBrowsingDbBasicInfoGet: (params: RequestParams = {}) =>
      this.request<any, any>({
     ...
     */
    getDbExpiredInfiniteImageBrowsingDbExpiredDirsGet: (params: RequestParams = {}) =>
      this.request<any, any>({
     ...
     */
    updateImageDbDataInfiniteImageBrowsingDbUpdateImageDataPost: (params: RequestParams = {}) =>
      this.request<any, any>({
     ...
     */
    matchImageByTagsInfiniteImageBrowsingDbMatchImagesByTagsPost: (
      data: MatchImagesByTagsReq,
      params: RequestParams = {},
    ) =>
      this.request<any, HTTPValidationError>({
     ...
     */
    getImgSelectedCustomTagInfiniteImageBrowsingDbImgSelectedCustomTagGet: (
      query: {
        /** Path */
        path: string;
      },
     ...
     */
    toggleCustomTagToImgInfiniteImageBrowsingDbToggleCustomTagToImgPost: (
      data: ToggleCustomTagToImgReq,
      params: RequestParams = {},
    ) =>
      this.request<any, HTTPValidationError>({
     ...
     */
    addCustomTagInfiniteImageBrowsingDbAddCustomTagPost: (data: AddCustomTagReq, params: RequestParams = {}) =>
      this.request<any, HTTPValidationError>({
     ...
     */
    removeCustomTagInfiniteImageBrowsingDbRemoveCustomTagPost: (data: RemoveCustomTagReq, params: RequestParams = {}) =>
      this.request<any, HTTPValidationError>({
     ...
     */
    removeCustomTagFromImgInfiniteImageBrowsingDbRemoveCustomTagFromImgPost: (
      data: RemoveCustomTagFromReq,
      params: RequestParams = {},
    ) =>
      this.request<any, HTTPValidationError>({
     ...
     */
    searchBySubstrInfiniteImageBrowsingDbSearchBySubstrGet: (
      query: {
        /** Substr */
        substr: string;
      },
     ...
     */
    readScannedPathsInfiniteImageBrowsingDbScannedPathsGet: (params: RequestParams = {}) =>
      this.request<ScannedPathModel[], any>({
     ...
     */
    createScannedPathInfiniteImageBrowsingDbScannedPathsPost: (data: ScannedPathModel, params: RequestParams = {}) =>
      this.request<any, HTTPValidationError>({
        path: `/infinite_image_browsing/db/scanned_paths`,
        method: "POST",
        body: data,
     ...
     */
    deleteScannedPathInfiniteImageBrowsingDbScannedPathsDelete: (data: ScannedPathModel, params: RequestParams = {}) =>
      this.request<any, HTTPValidationError>({
        path: `/infinite_image_browsing/db/scanned_paths`,
        method: "DELETE",
        body: data,
  ...
  sam = {
     ...
     */
    heartbeatSamHeartbeatGet: (params: RequestParams = {}) =>
      this.request<any, any>({
        path: `/sam/heartbeat`,
        method: "GET",
        format: "json",
     ...
     */
    apiSamModelSamSamModelGet: (params: RequestParams = {}) =>
      this.request<string[], any>({
        path: `/sam/sam-model`,
        method: "GET",
        format: "json",
     ...
     */
    apiSamPredictSamSamPredictPost: (data: SamPredictRequest, params: RequestParams = {}) =>
      this.request<any, HTTPValidationError>({
     ...
     */
    apiDinoPredictSamDinoPredictPost: (data: DINOPredictRequest, params: RequestParams = {}) =>
      this.request<any, HTTPValidationError>({
     ...
     */
    apiDilateMaskSamDilateMaskPost: (data: DilateMaskRequest, params: RequestParams = {}) =>
      this.request<any, HTTPValidationError>({
     ...
     */
    apiControlnetSegSamControlnetSegPost: (
      data: BodyApiControlnetSegSamControlnetSegPost,
      params: RequestParams = {},
    ) =>
      this.request<any, HTTPValidationError>({
     ...
     */
    apiCategoryMaskSamCategoryMaskPost: (data: BodyApiCategoryMaskSamCategoryMaskPost, params: RequestParams = {}) =>
      this.request<any, HTTPValidationError>({
