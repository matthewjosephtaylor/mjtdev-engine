function match(s1: string | RegExp, s2: string | RegExp): boolean | undefined {
  if (s1 === s2) {
    return true;
  }
 ...
 */
function hashFnv32a({ str, seed }: { str: string; seed?: number }): number {
  /*jshint bitwise:false */
  let i: number,
    l: number,
    hval: number = seed === undefined ? 0x811c9dc5 : seed;
