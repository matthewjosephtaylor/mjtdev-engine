...
export declare const getMaterial: <T extends VisualMaterialType = keyof MaterialTypeMap>(scene: Scene, name: string, options?: T | AllMaterialOptions) => MaterialTypeMap[T];
export {};
