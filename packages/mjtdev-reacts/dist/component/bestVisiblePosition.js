...
export const bestVisiblePosition = (rect, parentRect) => {
    if (isUndefined(rect) || isUndefined(parentRect)) {
        return undefined;
    }
    const { left, top, bottom, right, width, height } = rect;
    const { left: pLeft, right: pRight, top: pTop, bottom: pBottom, width: pWidth, height: pHeight, } = parentRect;
...
//# sourceMappingURL=bestVisiblePosition.js.map